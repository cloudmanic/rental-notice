<div>
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">A list of all your tenants including their name and full address.</p>
        </div>
        ...
        <div class="min-w-0 flex-1">
            <div class="relative rounded-md shadow-sm">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                    ...
                    <svg wire:loading wire:target="search" class="animate-spin h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                @if($search)
                <button type="button" wire:click="$set('search', '')" class="absolute inset-y-0 right-0 flex items-center pr-2">
    ...
    <div class="mt-8 flow-root">
        ...
        <div wire:loading.delay.long.remove wire:target="search, sortBy" class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
