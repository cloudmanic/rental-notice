<div>
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">Update tenant information in your account.</p>
        </div>
    </div>
    ...
    <form wire:submit="update" class="mt-6 space-y-8">
        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-3">
                ...
                <p class="mt-1 text-xs text-gray-500">We never email tenants without your permission.</p>
                ...
                <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Delete Tenant</h3>
                            <div class="mt-2">
