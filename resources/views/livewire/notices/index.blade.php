                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500">
                            ...
                            <div class="relative group">
                                ...
                                <div class="hidden group-hover:block absolute z-10 left-0 mt-1 bg-white rounded-md shadow-lg p-2 border border-gray-200 w-64">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Try clearing your search filters to see more results.</p>
                                <div class="mt-6">
