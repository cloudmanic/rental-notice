<div class="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    @if($notice->status === 'service_pending')
    <div class="mb-6 bg-blue-50 border-l-4 border-blue-400 p-4 rounded-lg">
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-blue-800">Service in Progress</h3>
                <div class="mt-2 text-sm text-blue-700">
                    <p>The service of this notice is currently underway. You will receive an email after service is complete.</p>
                </div>
            </div>
        </div>
    </div>
