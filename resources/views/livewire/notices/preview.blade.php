<div class="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex space-x-4">
            ...
            <a href="{{ route('stripe.checkout', $notice->id) }}"
                class="plausible-event-name=proceed-to-payment px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Proceed to Payment
            </a>
        </div>
    </div>
