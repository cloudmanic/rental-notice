...
@section('description', 'Oregon Past Due Rent helps landlords issue legally compliant past-due rent notices with professional delivery for just $15 per notice.')

@section('content')
<!-- Hero Section -->
<div class="relative bg-indigo-800 overflow-hidden">
    <div class="absolute inset-0">
        <img class="w-full h-full object-cover" src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1973&q=80" alt="Oregon apartment building">
    ...
    <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        ...
        <p class="mt-6 text-xl text-indigo-100 max-w-3xl">
            Issue legally compliant 10-day or 13-day nonpayment notices with professional delivery for just $15 per notice.
            Designed specifically for Oregon landlords and property managers.
        </p>
        <div class="mt-10 flex flex-col sm:flex-row gap-4 sm:gap-6">
            <a href="{{ route('register') }}" class="inline-flex w-full sm:w-auto items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:text-lg">
                Get Started Today
            </a>
            <a href="{{ route('marketing.how-it-works') }}" class="inline-flex w-full sm:w-auto items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-300 bg-indigo-800 hover:bg-indigo-700 md:text-lg">
                Learn How It Works
            </a>
        </div>
    </div>
                ...
                <div class="relative">
                    ...
                    <div class="ml-16">
                        ...
                        <p class="mt-2 text-base text-gray-500">
                            Our notices are fully compliant with Oregon's specific laws, including all recent legal updates.
                        </p>
                    </div>
                </div>
...
<div class="bg-gray-50 py-16 sm:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="lg:grid lg:grid-cols-3 lg:gap-x-8">
                <div class="relative">
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div class="absolute top-6 left-6 bg-indigo-600 rounded-full h-12 w-12 flex items-center justify-center">
                        ...
                        <div class="px-8 pt-16 pb-8">
                            ...
                            <p class="mt-4 text-base text-gray-500">
                                Fill out our simple form with tenant details, rental property information, and past-due rent amount.
                            </p>
                ...
                <div class="mt-10 lg:mt-0">
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div class="px-8 pt-16 pb-8">
                            ...
                            <p class="mt-4 text-base text-gray-500">
                                Our team generates the legally compliant notice and delivers it according to Oregon law requirements.
                            </p>
                            <ul class="mt-6 space-y-2">
                                <li class="flex">
                                    <svg class="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="mt-10 lg:mt-0">
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div class="px-8 pt-16 pb-8">
                            ...
                            <p class="mt-4 text-base text-gray-500">
                                You'll receive detailed documentation of the service for your records and potential legal proceedings.
                            </p>
                            <ul class="mt-6 space-y-2">
                                <li class="flex">
                                    <svg class="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="mt-10 text-center">
            <a href="{{ route('marketing.how-it-works') }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700">
...
<div class="bg-white py-16 sm:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="bg-gray-50 rounded-xl shadow-md overflow-hidden p-6">
                    ...
                    <p class="mt-4 text-lg italic text-gray-600">
                        "This service saved me so much time and hassle. The notice was delivered properly, and the documentation was perfect for court when my tenant didn't pay."
                    </p>
                    <div class="mt-6">
                ...
                <div class="bg-gray-50 rounded-xl shadow-md overflow-hidden p-6">
                    ...
                    <p class="mt-4 text-lg italic text-gray-600">
                        "As a property manager handling 50+ units, this service has been a game-changer. The bulk pricing saves us money and the quick turnaround keeps our operation running smoothly."
                    </p>
                    <div class="mt-6">
                ...
                <div class="bg-gray-50 rounded-xl shadow-md overflow-hidden p-6">
                    ...
                    <p class="mt-4 text-lg italic text-gray-600">
                        "I was afraid of making a mistake with the notice process. This service made it easy and gave me peace of mind knowing everything was done correctly according to Oregon law."
                    </p>
                    <div class="mt-6">
            ...
            <div class="mt-10 text-center">
                <a href="{{ route('marketing.testimonials') }}" class="text-base font-medium text-indigo-600 hover:text-indigo-500">
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
        ...
        <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
            ...
            <div class="ml-3 inline-flex rounded-md shadow">
                <a href="{{ route('marketing.pricing') }}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                    View Pricing
                </a>
            </div>
        </div>
