...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-base font-semibold text-indigo-600 tracking-wide uppercase">See How It Works</h2>
            <p class="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">
                Watch Our Quick Tutorial
            </p>
            <p class="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
                Learn how our simple process helps Oregon landlords serve legally compliant past-due rent notices in just a few minutes.
            </p>
        </div>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="relative rounded-lg shadow-lg overflow-hidden cursor-pointer" style="padding-bottom: 56.25%;" onclick="openVideoModal()">
                <img src="https://img.youtube.com/vi/Jq11xBUVoqg/maxresdefault.jpg" alt="Oregon Past Due Rent Notice Video Tutorial" class="absolute inset-0 w-full h-full object-cover">
